    ...
    <p class="name">品牌经营信息</p>
     <div class="contents">
      <div class="messagetable">
        <el-table class="tables" id="tb" :data="tableData4" height="6rem"  border 
          style="width: 100%;text-align:center"  :header-cell-style="headerStyle"
          >
      ...
      shopClick(code,name) {
        ...
        // console.log('00')-
          ...
          vm.names = name
           this.code = code
           let domain = hostType(1)
            vm.$axios.get(`${domain}`+"/wechat/api/myshop/?license="+code).then(
            // vm.$axios.get("http://192.168.1.40:8000/wechat/api/myshop/?license="+code).then(
          function (response) {
            // console.log(code)
